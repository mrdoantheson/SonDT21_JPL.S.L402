...
public class HashMapRemoveKeyExample {
    ...
    public void removeKeys() {
        ...
        // Ex - Unfortunately, Chris got divorced.
        // Let's remove him from the mapping
        ...
        // Remove a key from the HashMap only if it is mapped to
        // the given value
        ...
        // remove() returns null if the mapping was not found for
        // the supplied key
